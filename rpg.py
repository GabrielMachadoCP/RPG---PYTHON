...
#LINHA QUE ESTOU TRABALHANDO NO MOMENTO: 3400
...
while energia > 0 or venceu == False :
    ...
    #Abrindo a porta para o norte
        ...
        #Engatinhar pelo túnel
        if escolha == 1 :
            print(textos.T301())
            resposta = int(input("Escolha: "))
            
            #Engatinhando de volta para ver a caixa
            print(textos.T162())
            safira += 1
            sorte += 1
            
            #Seguir em frente pelo cano
            print(textos.T4())
            energia = 0
        
        #Continuar par o norte
        print(textos.T142())
    
    #Vai chegar aqui de qualquer maneira
    print(textos.T338())
    escolha = int(input("Escolha: "))
    ...
    #Não pegando o colar/continuando viagem
    print(textos.T282())
    resposta = int(input("Escolha: "))
    
    #Não aceitando a oferta
    if resposta == 2 :
        print(textos.T388())
        escolha = int(input("Escolha: "))
        ...
        #Voltando para o bárbaro
        print(textos.T154())
    
    #Vai voltar para ele de qualquer jeito
    print(textos.T22())
    escolha = int(input("Escolha: "))
    ...
    if escolha == 2 :
        ...
        #Ficando com o bárbaro
        if resposta == 1 :
            print(textos.T323())
        
        #Abandonando o bárbaro
        elif resposta == 2 :
            print(textos.T149())
            input("\nTeste sua sorte...")
            teste_da_sorte = random.randint(1,6) + random.randint(1,6)
    ...
    #Juntando-se com Thorn
    if resposta == 1 :
        print(textos.T179())
    
    #Iniciando o teste direto
    elif resposta == 2 :
        print(textos.T365())
    ...
    #Não acertando
        ...
        #Engolindo com a letra S
        if resposta == 1 :
            print(textos.T26())
            habilidade -= 2
        
        #Engolindo com a letra L
        elif escolha == 2 :
            print(textos.T354())
            sorte -= 2
    
    #Teste para pegar a cobra
    input("Jogue os dados...🎲")
    teste_da_habilidade = random.randint(1,6) + random.randint(1,6)
    
    while teste_da_habilidade > habilidade :
        print(textos.T202())
        input("\nTeste sua sorte...")
        teste_da_sorte = random.randint(1,6) + random.randint(1,6)
