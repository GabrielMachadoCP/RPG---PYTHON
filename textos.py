...
def T18() :
    return "\nPara sorte sua, os dentes da naja se cravam na munhequeira de couro que você está usando. A serpente se enrosca de novo bem depressa, pronta para lançar outro ataque, quando o Anão ordena que você faça mais uma tentativa."
...
def T23() :
    return """\nO papel traz uma advertência simples, escrita em sangue seco: "Cuidado com os Juízes da Prova." Você recoloca o papel no prego e corre de volta pelo túnel para se reunir ao Bárbaro."""
...
def T32() :
    return """\nVocê logo chega a uma outra encruzilhada no túnel. Um braço leva para o leste, mas as pegadas úmidas que você vem seguindo continuam para o norte, e você resolve continuar na trilha delas."""
...
def T39() :
    ...
    \nVocê vai: \n(1)Enfrentá-la\n(2)Automaticamente perder 2 pontos de energia e fugir, evitando a batalha"""
...
def T42() :
    return "\nOs dentes da naja se cravam fundo no seu pulso e você sente o veneno se alastrando pelo corpo. Você perde 5 pontos de ENERGIA."
...
def T50() :
    return "\nVocê acorda e vê Throm puxando o anel do seu dedo. Ele joga o anel no chão e o esmaga com a acha de guerra. Em seguida, grunhindo para expressar que desaprova sua atitude, sai caminhando para o leste. Com esforço, você se levanta e o segue cambaleante."
...
def T52() :
    ...
    \nVocê vai: (1)Abrir o livro preto\n(2)Prosseguir para o norte com Throm"""


def T52_2() :
    return """\nAo abrir o livro, você vê que ele começa a se desintegrar. As páginas se transformando em poeira nas suas mãos. Mas você consegue salvar alguns fragmentos e ler o manuscrito. O livro parece ser sobre monstros, e, do que você pode concluir, contém uma descrição completa de um ser chamado Besta Sangrenta. É uma horrível criatura inchada, com pele grossa e coberta de espinhos e úlceras faciais que se abrem para se tornar falsos olhos, cujo objetivo é esconder o único ponto fraco da Besta Sangrenta - seus olhos verdadeiros. Essas monstruosidades geralmente habitam poços de lodo fétido que exalam gás venenoso, tão forte que pode facilmente deixar uma pessoa inconsciente. A Besta Sangrenta, embora pesada demais para sair da poça de lodo, tem uma língua longa e poderosa que se enrosca em torno de suas vítimas para arrastá-las para o interior da poça. Quando a carne das vítimas começa a apodrecer no lodo abjeto, a Besta Sangrenta a devora. Você conta a Throm sobre a grotesca Besta Sangrenta, mas ele simplesmente sacode os ombros e lhe diz para seguir adiante.
    
    \nVocê vai: (1)Voltar para o livro preto e beber o líquido\n(2)Voltar para o livro preto e passar o líquido em seus ferimentos\n(3)Prosseguir para o norte com Throm"""


def T52_3() :
    return "\nAo abrir o livro, você vê que ele começa a se desintegrar. As páginas se transformando em poeira nas suas mãos. Mas você consegue salvar alguns fragmentos e ler o manuscrito. O livro parece ser sobre monstros, e, do que você pode concluir, contém uma descrição completa de um ser chamado Besta Sangrenta. É uma horrível criatura inchada, com pele grossa e coberta de espinhos e úlceras faciais que se abrem para se tornar falsos olhos, cujo objetivo é esconder o único ponto fraco da Besta Sangrenta - seus olhos verdadeiros. Essas monstruosidades geralmente habitam poços de lodo fétido que exalam gás venenoso, tão forte que pode facilmente deixar uma pessoa inconsciente. A Besta Sangrenta, embora pesada demais para sair da poça de lodo, tem uma língua longa e poderosa que se enrosca em torno de suas vítimas para arrastá-las para o interior da poça. Quando a carne das vítimas começa a apodrecer no lodo abjeto, a Besta Sangrenta a devora. Você conta a Throm sobre a grotesca Besta Sangrenta, mas ele simplesmente sacode os ombros e lhe diz para seguir adiante. Deizando o livro e frasco de lado, você prossegue para o norte com Throm."
...
def T54() :
    return "\nO laço se solta e você consegue tirá-lo do pescoço do ídolo com uma sacudidela. Ele cai ao chão com um ruído alto. Você enrola a corda rapidamente e a coloca na mochila. Sem perder mais tempo na caverna, corre para o túnel na parede norte."
...
def T64() :
    return "\nLogo que você põe o anel no dedo, todo seu corpo começa a tremer."
...
def T75() :
    return """\nVocê esfrega o líquido nos seus ferimentos, mas eles não saram. Olhando fixamente para a garrafa vazia, você fica se perguntando o que o líquido seria exatamente.

    \nAgora você faz o que? \n(1)Abre o livro vermelho\n(2)Continua para o norte com Throm"""


def T75_2() :
    return "\nVocê esfrega o líquido nos seus ferimentos, mas eles não saram. Olhando fixamente para a garrafa vazia, você fica se perguntando o que o líquido seria exatamente. Deixando o frasco de lado, você continua para o norte com Throm."


def T76() :
    return """\nVocê dá a volta pela enorme massa morta do Verme da Rocha e dá uma espiada dentro da escuridão de seu buraco perfurado. Você só consegue ver alguns metros, mas pode notar que ele se inclina levemente e é tímido por causa da gosma secretada pelo Verme da Rocha.

    \nVocê vai: \n(1)Explorar o buraco de broca\n(2)Caminhar para o oeste pelo túnel"""
...
def T78() :
    return """\nHá um cano com cerca de um metro de diâmetro aberto na parede da direita. Está escuro demais para se ver muito abaixo nele. Você grita dentro do cano de ferro e ouve sua voz ecoar por alguns instantes até desaparecer.

    \nVocê vai: \n(1)Engatinhar pelo cano\n(2)Continuar para o norte"""
...
def T80() :
    return "\nVocê vai com calma e consegue passar pelo último poste sem ter tocado em nenhum deles. Corre para o leste, ainda seguindo os dois pares de pegadas."
...
def T107() :
    return """Você chega a uma porta em arco localizada na parede à direita do túnel. A pesada porta de pedra está fechada, mas há um trinco de ferro e uma maçaneta redonda.

    \nVocê: \n(1)Tenta a porta\n(2)Continua pelo túnel"""
...
def T110() :
    return """\nO túnel logo faz uma outra curva fechada para a direita. Seguindo para o leste, você chega a uma estranha obstrução: uma linha de 12 postes de madeira atravessados no túnel. Eles estão fixos às paredes a cerca de meio metro do chão, com um espaço de um metro entre eles.
    \nVocê: \n(1)Caminha entre os postes\n(2)Sobe pelos postes e passa sobre a obstrução"""


def T111() :
    return "\nVocê limpa o viscoso lodo amarelo da lâmina de sua espada e caminha rapidamente para a porta, de volta para o túnel, e segue para o norte."
...
def T117() :
    return """\nDepois de uma longa caminhada pelo túnel, você chega a um beco sem saída. Um grande espelho, que vai do chão até o teto, está colocado na parede do fundo. Na penumbra, você só consegue visualizar vagamente o seu próprio reflexo.

    \nVocê: \n(1)Olhar o espelho mais de perto\n(2)Faz a longa caminhada de volta para a última encruzilhada no túnel, a fim de prosseguir para o leste"""
...
def T119() :
    return """\nAdiante, você pode ver um grande obstáculo no chão do túnel, embora esteja escuro demais para saber exatamente o que é. As pegadas molhadas que você vem seguindo continuam até a obstrução.
    \nVocê: \n(1)Continua para o leste\n(2)Volta para a encruzilhada e seguir para o oeste"""
...
def T121() :
    return """\nO Anão olha para os dados. “Você não é muito bom nesse jogo, é?”, graceja. “Lamento, mas você terá que sofrer uma penalidade antes de continuar.” Ele retira duas pílulas do bolso. Uma está marcada com a letra S e a outra com a letra L. Pede que você escolha uma e engula.

    \nQual você engolhe? \n(1)A marcada com S\n(2)A marcada com L"""


def T122() :
    return "\nÀ sua frente, há dois lances de escadas de pedra, separados por um corrimão de crânios de ratazana. Você pode subir pelo lance de escadas da esquerda ou pelo da direita, qual prefere? \n(1)Esquerda\n(2)Direita"


def T123() :
    return "\nO colar é um amuleto de força. Você ganha 1 ponto de HABILIDADE e 1 ponto de ENERGIA."
...
def T130() :
    return """\nOs Hobgoblins param de lutar imediatamente. Eles não entendem o que você está dizendo e rosnam agressivamente. Em seguida, desembainham as espadas curtas e avançam para atacá-lo."""
...
def T135() :
    return "\nPassando pelo buraco perfurado do Verme da Rocha, à sua esquerda, você logo chega à encruzilhada. Dá uma olhada rápida no túnel que conduz ao sul, mas não vê ninguém se aproximando. Apressando o passo, você segue velozmente para o leste"


def T136() :
    return """\nA porta abre para um outro túnel, que se inclina numa subida ao longe. Depois de percorrer essa subida por algum tempo, você chega a uma parte plana, onde numa porta na parede da direita encontra-se pregada uma mão já decomposta.
...
def T138() :
    ...
    \nVocê: (1)Beberá o líquido?\n(2)Esfregará o líquido nos seus ferimentos\n(3)Abrirá o livro vermelho\n(4)Deixará a garrafa e o livro de lado para continuar para o norte com Throm"""


def T138_2() :
    return """\nAs páginas do livro estão unidas com lacre, mas um pequeno orifício foi cortado no meio delas, de tamanho suficiente para conter uma pequena garrafa arrolhada, na qual há um líquido de cor clara. Você mostra isso a Throm, que levanta a mão, indicando não querer que você sequer chegue perto dele com aquilo; a desconfiança que ele sente em relação às coisas desconhecidas fica evidente.

    \nVocê: (1)Beberá o líquido?\n(2)Esfregará o líquido nos seus ferimentos\n(3)Deixará a garrafa e o livro de lado para continuar para o norte com Throm"""
...
def T142() :
    return "\nHá uma nova ramificação no túnel à sua esquerda, e, à frente, você vê dois corpos estendidos no chão. Você pára e dá uma espiada no novo túnel, mas, não vendo nem portas nem criaturas, resolve seguir por ele. Com a espada na mão, você caminha na direção dos corpos estendidos."
...
def T149() :
    return "\nocê solta a corda e ouve ela cair no fundo do poço. O Bárbaro o amaldiçoa, prometendo matá-lo se seus caminhos se cruzarem outra vez. Você recua, toma distância e salta. Cai em segurança do outro lado do poço e continua para o oeste. Mais adiante no túnel, você pisa em uma parte do chão de pedra que se inclina para frente, disparando uma armadilha que solta um rochedo preso frouxamente no teto. Você olha para cima bem no momento em que o rochedo está prestes a cair sobre você."
...
def T154() :
    return "\nCorrendo pelo túnel, você logo alcança o Bárbaro e diz a ele que a passagem do leste conduz a um beco sem saída. Ele faz um aceno com a cabeça, num entendimento silencioso, e ambos partem para o oeste."
...
def T158() :
    return """\nVocê leva a moringa aos lábios e toma um gole. O líquido queima tanto que você larga a moringa e segura a garganta em agonia. Você engoliu ácido! Perde 1 ponto de HABILIDADE e 4 de ENERGIA."""
...
def T162() :
    return "\nRetirando a tampada caixa na luz do túnel, você encontra uma chave de ferro e uma gema grande. É uma safira. Some 1 ponto de SORTE. Colocando as coisas cuidadosamente na mochila, você parte para o norte mais uma vez."
...
def T168() :
    ...
    \nVocê: \n(1)Tenta apanhar o punhal\n(2)Recua enojado e sai da caverna"""
...
def T176() :
    return "\nCaminhando cuidadosamente, você vai subindo os degraus devagar. Logo chega ao topo sem problemas. Continue pelo túnel."
...
def T184() :
    ...
    \nVocê vai: \n(1)Ficar com o Bárbaro e seguir para o norte pelo túnel inferior\n(2)Abandoná-lo, pulando por cima do poço para se dirigir ao oeste"""
...
def T190() :
    return "\nSeu corpo vibra desenfreadamente, e você não consegue evitar o desmaio. Você perde 3 pontos de ENERGIA."
...
def T194() :
    return """\nEm uma plataforma de pedra na parede do túnel, você vê dois livros empoeirados encadernados em couro. Throm expressa seu desprezo pela palavra escrita com um grunhido, insistindo para que você deixe os livros de lado e siga adiante com ele.

    \nVocê: \n(1)Abrirá o livro de couro vermelho\n(2)Abrirá o livro de couro preto\n(3)Continuará para o norte pelo túnel"""
...
def T202() :
    return "\nAs reações da naja são mais rápidas do que as suas, e a cabeça estufada do animal se projeta para mordê-lo."
...
def T210() :
    return """\nVocê entra em um aposento no qual há um homem maltrapilho, de pé, acorrentado, à parede pelo braço esquerdo. Vendo que ele não tem a mão direita, você se dá conta de que a mão pregada na porta deve ser dele. Implorando piedade, ele se encolhe para longe de você, tanto quanto as correntes permitem.

    \nO que você vai fazer? \n(1)Libertá-lo das cadeias\n(2)Sair do aposento e se dirigir oara o norte"""
...
def T221() :
    return """\nO túnel conduz a uma caverna úmida de teto alto, como chão coberto de rochas. Estalactites em forma de dentes pendem ameaçadoramente, os pingos constantes criando poças leitosas no chão. O túnel prossegue atravessando a passagem em arco, a qual é talhada na forma de uma boca demoníaca.

    \nVocê vai: \n(1)Examinar a caverna\n(2)Prosseguir direto pela passagem em arco"""
...
def T231() :
    return "\nVocê encontra uma poça atrás dos Hobglobins mortos e toma grandes goles de água fresca o mais rápido possível. Isso neutraliza o ácido e, lentamente, você começa a se recuperar. Ainda com dor, você se levanta e parte para o norte."
...
def T240() :
    return """\nVocê olha para baixo e vê esparramados no chão os corpos inertes dos Guardiães Voadores. Você começa a forçar o olho esquerdo de esmeralda do ídolo com a ponta da espada. Finalmente, ele se solta e cai na sua mão; o peso da pedra o deixa surpreso. Esperando que seja de utilidade mais tarde, você a guarda na mochila.
    \nVocê: (1)Força o olho direito\n(2)Desce do ídolo"""
...
def T254_2() :
    return "\nVocê: \n(1)Tem certexa do que quer e vai para a luta\n(2)Foge e automaticamente perde dois pontos de energia"
...
def T267() :
    return """\nO túnel logo termina em uma encruzilhada. Olhando para a esquerda e para a direita, você vê uma passagem estreita que desaparece na penumbra da distância.

    \nVocê: \n(1)Se dirige para o oeste\n(2)Segue para o leste"""
...
def T277() :
    return "\nO túnel faz uma curva fechada para a direita e depois, uns 100 metros adiante, chega a um cruzamento. Olhando para a esquerda, você vê dois corpos caídos no chão. Resolve chegar perto e investigar."
...
def T282() :
    return """\nO túnel logo termina em uma encruzilhada. Parado lá sozinho e sem saber para que lado ir está um de seus rivais. É um dos Bárbaros. Você o chama, mas ele não responde; apenas olha fria e fixamente para você, segurando a acha com firmeza. Você anda até ele e pergunta para que lado está indo. Ele grunhe sua resposta, dizendo que está indo para o oeste, e, se quiser, você pode ir com ele.

    \nVocê: \n(1)Aceita a oferta e segue para o oeste com o Bárbaro\n(2)Recusa a oferta e segue para o leste sozinho"""
...
def T295() :
    return "\nCorrendo na direção da passagem em arco, você tropeça numa pedra e perde o equilíbrio. Você cai estatelado no chão, e, antes que tenha tempo de levantar-se, uma estalactite despenca, rasgando-lhe a perna com a ponta aguçada. Você perde 5 pontos de ENERGIA."
...
def T301() :
    ...
    \nVocê vai: \n(1)Engatinhar de volta e sair do cano para examinar o achado\n(2)Seguir em frente pelo cano, levando a caixa para examinar mais tarde"""
...
def T313() :
    return "\nO túnel termina em uma encruzilhada. As pegadas que você vem seguindo viram para o norte, e você resolve manter-se na trilha delas."
...
def T323() :
    return "\nDepois de amarrar a corda em torno da rocha, você desce devagar para o fundo do poço. Throm recupera a corda dele, soltando-a da rocha com uma sacudidela, e vocês partem juntos pelo novo túnel."
...
def T338() :
    return """\nOs corpos são de dois guardas Orcas. Pelo menos um de seus rivais na Prova dos Campeões ainda deve estar à sua frente. De uma rápida revista aos corpos nada resulta senão um colar de dentes pendurado no pescoço de um dos Orcas.

    \nVocê vai: \n(1)Pegar e usar o colar\n(2)Partir para o norte sem o colar"""
...
def T344():
    return """\nO túnel faz curvas e reviravoltas, mas continua sempre para o norte. À sua frente, um facho de luz azul desce do teto para o chão. Ele faísca e cintila, e você pode ver imagens de rostos que riem na luz.

    \nVocê: \n(1)Passa através da luz\n(2)Contorna o facho"""
...
def T348() :
    return "\nVocê avança sobre a Besta Sangrenta, tentando evitar a língua que se estende para agarrar-lhe a perna. Jogue dois dados. Se o total for igual ou menor que a sua HABILIDADE, volte para 225. Se o total for maior que a sua HABILIDADE, volte para 159.\n"
...
def T351() :
    return "\nO ídolo é muito liso, e a escalada será difícil. Você tem corda?"
...
def T352() :
    ...
    \nVocê vai: \n(1)Lutar contra o Verme da Rocha\n(2)Correr de volta pelo túnel para o cruzamento, se dirigindo para o leste"""


def T353() :
    return "\nAntes que você possa sair do caminho, o rochedo se choca contra seu ombro. Você perde 1 ponto de HABILIDADE e 4 pontos de ENERGIA."
...
def T388() :
    return """\nO túnel logo chega a um beco sem saída. Um pedaço de papel, escurecido e enrugado de tão velho, está pregado na parede do fundo.

    \nVocê vai: \n(1)Pegá-lo para ver se contém alguma mensagem\n(2)Voltar pelo túnel para reunir-se ao Bárbaro"""
...
def T396() :
    ...
    \nVocê: \n(1)Arranca primeiro a do olho esquerdo\n(2)Arranca primeiro a do olho direito"""


def T397() :
    return """\nO líquido é uma poção mágica que lhe permitirá detectar armadilhas ocultas. Você ganha 2 pontos de SORTE.

    \nAgora você faz o que? \n(1)Abre o livro vermelho\n(2)Continua para o norte com Throm"""


def T397_2() :
    return """\nO líquido é uma poção mágica que lhe permitirá detectar armadilhas ocultas. Você ganha 2 pontos de SORTE. Deixando o livro para trás, você continua para o norte com Throm."""
